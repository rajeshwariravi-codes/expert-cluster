...
if ($Connection) {
    ...
    $Select_Stream_Query = "SELECT `Stream` FROM `Streams` WHERE Stream_ID = ?";
    $Select_Stream_Query_SQL = $Connection->prepare($Select_Stream_Query);
    $Select_Stream_Query_SQL->bind_param("s", $Stream_ID);
...
<main class="content p-0 p-sm-5">
                    ...
                    <div class="Form w-100">
                        <div class="row g-3 align-items-center">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input class="form-control" type="text" name="Expert_Name" id="Expert_Name" value="<?= $Expert_Name ?>" readonly required>
                            </div>
                            <div class="form-group col-md-6">
                        ...
                        <div class="Button d-flex justify-content-center gap-4 mt-3">
                            ...
                            <button type="submit" name="Back" class="" onclick="window.location.href = 'S_Experts_Query.php';">Back</button>
                        </div>
                    </div>
                </form>
            </div>
    ...
    if ($Connection) {
        ...
        if (isset($_POST["Ask"])) {
            ...
            $Insert_Query = "INSERT INTO `Query` (`Query_ID`, `Seeker_ID`,`Expert_ID`, `Stream_ID`, `Query_Title`, `Query`, `Query_Doc`)
                                VALUE (?,?,?,?,?,?,?)
                            ";
