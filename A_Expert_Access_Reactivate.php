...
if ($Connection) {
    ...
    if (isset($_POST['Page'])) {
        $_SESSION['ARe_Current_Page'] = $_POST['Page'];
    } elseif (!isset($_SESSION['ARe_Current_Page'])) {
        $_SESSION['ARe_Current_Page'] = 1;
    }

    $Page = $_SESSION['ARe_Current_Page'];
    $Page = max(1, (int)$Page);
    $Start = ($Page - 1) * $Limit;
    ...
    function Sent_Mail($Expert_Name, $E_Mail, $Password, $Expert_ID)
    {
        ...
        $message = '
                ...
                <head>
                    <style>
                        ...
                        .header {
                            ...
                            font-size: 24px;
                            font-weight: 700;
                            color: #10b981; /* green for success/granted */
                            margin-bottom: 20px;
                            text-align: center;
                        }
                ...
                <body>
                    <div class="container">
                        ...
                        <p>
                            Your expert profile has now been <strong>granted access</strong> by the admin on the <strong>Expert Cluster</strong> platform. 
                            You can start teaching learners in your selected streams immediately.
                        </p>
                        ...
                        <p class="note">
                            For security reasons, we recommend you change this password after logging in for the first time. 
                            Log in with your temporary password to set a new password of your choice and start sharing your expertise with learners.
                        </p>
    ...
    if (isset($_POST['Re_Grant'])) {
        ...
        if ($Update_Query_SQL->execute()) {
            Sent_Mail($Expert_Name, $E_Mail, $Password, $Expert_ID);
            echo "
                <script>
                    alert ('Expert access granted again!✨');
                    window.location.href = 'A_Expert_Access_Reactivate.php';
                </script>
            ";
        }
    }
...
<main class="content p-2">
    <div class="Wrapper">
        <div class="Nav-Bar container-fluid d-flex flex-wrap justify-content-center align-items-center gap-3 mb-4 p-3">
            ...
            <button onclick="window.location.href = 'A_Expert_Access_Restrict.php'" class="btn">Restrict</button>
            <button onclick="window.location.href = 'A_Expert_Access_Reactivate.php'" class="btn active">Reactivate</button>
        </div>
        <div class="Header">
                            ...
                            <div class="card-body d-flex flex-column mt-4">
                                ...
                                <div class="card-footer d-flex justify-content-center">
                                    <form action="" method="post">
                                        ...
                                        <?php
                                        echo "
                                            <button type='submit' class='btn fs-5' name='Re_Grant'>Re-Grant</button>
                                        ";
                                        ?>
                                    </form>
                                </div>
