    ...
    <div class="Wrapper">
        ...
        <div id="active-content" class="content-section fade-in">
            ...
            if ($Connection) {
                ...
                $T1_D_Type = "s" . str_repeat("s", count($Stream_ID)) . "s";
                            ...
                            <div class="form-group">
                                <select class="form-select" name="T1_Stream" id="T1_Stream">
                                    ...
                                    if ($Connection) {
                                        ...
                                        $Select_Stream_Query_SQL->bind_param("ss", $Expert_ID, $SQU_ID);
                                        $SQU_ID = "%SQU%";
                        ...
                        <tbody>
                            ...
                            if ($T1_Result->num_rows > 0) {
                                ...
                                while ($T1_Row = $T1_Result->fetch_assoc()) {
                                    ...
                                    // $T1_Query = htmlspecialchars_decode(str_replace('\\n', " ", $T1_Row['Query']));
                                    echo "<tr>";
                                    ...
                                    echo "<td scope='row' class='text-center'>
                                            <form method='post'>
                                                <input type='hidden' name='Query_ID' value='{$T1_Row['Query_ID']}'>
                                                <button type='submit' class='btn mb-1 fs-6' name='T1_Resolve' id='Resolve'>Resolve</button>
                                            </form>
                                        </td>";
                                    echo "</tr>";
                                    $T1_Serial_No++;
                            ...
                            if (isset($_POST['T1_Resolve'])) {
                                $_SESSION['Query_ID'] = $_POST['Query_ID'];

                                echo "
                                    <script>
                                        alert ('Let’s resolve this✨');
                                        window.location.href = 'E_Stream_Answer_Form.php';
                                    </script>
                                ";
                            }
                            ?>
        ...
        <div id="inactive-content" class="content-section" style="display:none;">
            ...
            if ($Connection) {
                ...
                $Query_Status = "Pending";
                $T2_Where = " WHERE Q.Query_ID LIKE ? AND Q.Expert_ID = ? AND Q.Query_Status = ? ";
                $T2_Params[] = "%" . "EQU" . "%";
                $T2_Params[] = $Expert_ID;
                $T2_Params[] = $Query_Status;
                $T2_D_Type = "sss";
                        ...
                        <tbody>
                            ...
                            if ($T2_Result->num_rows > 0) {
                                ...
                                while ($T2_Row = $T2_Result->fetch_assoc()) {
                                    ...
                                    echo "<td scope='row' class='text-center'>
                                            <form method='post'>
                                                <input type='hidden' name='Query_ID' value='{$T2_Row['Query_ID']}'>
                                                <button type='submit' class='btn mb-1 fs-6' name='T2_Resolve' id='Resolve'>Resolve</button>
                                            </form>
                                        </td>";
                                    echo "</tr>";
                                    $T2_Serial_No++;
                                ...
                                echo "<tr><td colspan='8' class='text-center text-muted'>No records available at the moment.</td></tr>";
                            }

                            if (isset($_POST['T2_Resolve'])) {
                                $_SESSION['Query_ID'] = $_POST['Query_ID'];

                                echo "
                                    <script>
                                        alert ('Let’s resolve this✨');
                                        window.location.href = 'E_Expert_Answer_Form.php';
                                    </script>
                                ";
                            }
                            ?>
...
<script>
    function Form_Reset() {
        window.location.href = 'E_My_Queries.php';
    }
</script>
