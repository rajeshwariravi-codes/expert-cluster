...
<body>
    <div class="Wrapper container">
        ...
        <div class="Division-Section d-flex flex-wrap justify-content-center gap-4">
            <button class="w-100 w-md-auto" onclick="window.location.href = 'Admin_Sign_In.php'">
                <div class="Admin-Section p-3">
                    ...
                    <div class="Admin-Details">
                        ...
                        <p class="Description Quote">Oversee the platform, manage users, and keep the system running smoothly.</p>
                    </div>
                </div>
            </button>

            <button class="w-100 w-md-auto" onclick="window.location.href = 'Expert_Sign_In.php'">
                <div class="Expert-Section p-3">
                    <div class="Expert-Head">
                        <i class="fa-solid fa-user-tie"></i>
                    </div>
                    <div class="Expert-Details">
                        <h3 class="Title">Expert Login</h3>
                        <p class="Description Quote">Share expertise, resolve queries, and guide learners with confidence.</p>
                    </div>
                </div>
            </button>

            <button class="w-100 w-md-auto" onclick="window.location.href = 'Seeker_Sign_In.php'">
                <div class="Seeker-Section p-3">
                    <div class="Seeker-Head">
                        <i class="fa-solid fa-user-graduate"></i>
                    </div>
                    <div class="Seeker-Details">
                        <h3 class="Title">Seeker Login</h3>
