    ...
    if (isset($_POST['Ask'])) {
        ...
        echo "
            <script>
                ...
                window.location.href = 'S_Stream_Query_Form.php';
            </script>
        ";
    }
}
...
<link rel="stylesheet" href="./S_Streams.css">
...
<main class="content p-2">
    <div class="Wrapper">
        <div class="Nav-Bar container-fluid d-flex flex-wrap justify-content-center align-items-center gap-3 mb-4 p-3">
            ...
            <button onclick="window.location.href = 'S_Streams_Query.php'" class="btn active">Streams</button>
            <button onclick="window.location.href = 'S_Experts_Query.php'" class="btn">Experts</button>
        </div>
        <div class="Header">
        ...
        <div class="Card-Wrapper m-3 row">
            <?php
                        ...
                        <div class="card shadow-sm rounded-4 overflow-hidden">
                            ...
                            <div class="card-footer d-flex justify-content-end">
                                <form action="" method="post">
                                    ...
                                    <button type="submit" name="Ask" id="Ask" class="btn fs-6">Ask Away</button>
                                </form>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        function Form_Reset() {
            window.location.href = 'S_Streams_Query.php';
        }
    </script>
