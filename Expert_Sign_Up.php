...
<body>
    ...
    if ($Connection) {
        ...
        if (isset($_POST['Submit'])) {
            ...
            $Select_Query = "SELECT E_Mail FROM Expert";
            ...
            if (!empty($E_Mail_ID) && !empty($Expert_Password)) {
                if (!preg_match('~[\w\.-]+@[\w\.-]+\.\w{2,}~', $E_Mail_ID)) {
                ...
                } elseif (in_array($E_Mail_ID, $E_Mail)) {
                    $Old_E_Mail = "Looks like this email is already in use. Try registering with another one.";
                    $E_Mail_Value = $E_Mail_ID;
                } else {
                    $Insert_Query = "INSERT INTO `Expert`(`Expert_ID`, `E_Mail`, `Password`) VALUES (?, ?, ?)";
                    $Insert_Query_SQL = $Connection->prepare($Insert_Query);
                    $Insert_Query_SQL->bind_param("sss", $Expert_ID, $E_Mail_ID, $Expert_Password);
                    ...
                    echo "
                        <script>
                            ...
                            window.location.href = './Expert_Register_Form.php';
                        </script>
                    ";
                }
            } else {
    ...
    <div class="Wrapper container justify-content-center">
        <div class="w-100 w-md-auto p-3">
            <div class="Expert-Details">
                <h3 class="Title text-center">Expert Sign Up</h3>
                    ...
                    <div class="Form w-100">
                        <div class="form-group md-3">
                            ...
                            <div class="position-relative">
                                ...
                                <input class="form-control" type="email" name="Mail_Id" id="Mail_Id" placeholder="Enter The E-Mail Id" value="<?= $E_Mail_Value; ?>" data-next="Password" autofocus autocomplete="off" required>
                            </div>
                        </div>
                        ...
                        <div class="Already text-center mt-3">
                            <p class="small mb-0">
                                ...
                                <a href="./Expert_Sign_In.php">Sign In</a>
                            </p>
                        </div>
                    </div>
                </form>
