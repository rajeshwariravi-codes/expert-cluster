...
<head>
    ...
    <title>Expert Cluster | Seeker Dashboard</title>
...
<body>
    ...
    <?php
    if ($Connection) {
        $Select_Query = "SELECT * FROM `Seeker` WHERE Seeker_ID = ?";
        $Select_Query_SQL = $Connection->prepare($Select_Query);
        $Select_Query_SQL->bind_param("s", $Seeker_ID);
    ...
    <div class="Container">
        ...
        <div class="main-content">
            ...
            <aside class="sidebar" id="sidebar">
                <div class="header">
                    <h3 class="">Hi!</h3>
                    <h1 class=""><?= $Seeker_Name ?></h1>
                </div>
                <li class="nav-item" style="list-style: none; margin-left: 30px;">
                    <a href="./Seeker_Dashboard.php" class="nav-link">
                ...
                <ul class="nav-menu" id="sidebarAccordion">
                    ...
                    <li class="nav-item">
                        <a href="./S_Core_Records.php" class="nav-link">
                    ...
                    <li class="nav-item">
                        <a href="./S_Query_Control.php" class="nav-link">
                    ...
                    <li class="nav-item">
                        <a href="./S_Query_&_Answer_Control.php" class="nav-link">
                    ...
                    <!-- <li class="nav-item">
                        <a href="./S_My_Query_Control.php" class="nav-link">
