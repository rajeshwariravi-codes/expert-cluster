...
<body>
                    ...
                    <div class="Form w-100">
                        ...
                        <div class="row md-3">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input class="form-control" type="email" name="E_Mail" id="E_Mail" placeholder="Enter The E-Mail" value="<?php echo $E_Mail_ID; ?>" data-next="City" required readonly>
                            </div>
                        </div>
                        <div class="row md-3">
                            <div class="form-group col-md-6">
    ...
    if ($Connection) {
        ...
        function Sent_Mail($Expert_Name, $E_Mail_ID, $Expert_ID, $Streams_Text)
        {

            $Name = htmlentities($Expert_Name);
            $Email = htmlentities($E_Mail_ID);
            $mailsubject = "Your Expert Cluster Registration Confirmation";
            ...
            $message = '
                ...
                <body>
                    <div class="container">
                        <div class="header">Welcome to Expert Cluster, ' . htmlspecialchars($Name) . '</div>

                        <p>
                            Congratulations! Your expert profile has been <strong>successfully created</strong> on the <strong>Expert Cluster</strong> platform.
                        </p>
                        ...
                        <div class="highlight-box">
                            ...
                            <div class="value">
                                ...
                                ' . htmlspecialchars($Streams_Text) . '
                            </div>
                        </div>

                        <p class="note">
                            You can now log in and set your password to start handling your streams. For security reasons, please ensure you create a strong password.
                        </p>
        ...
        if (isset($_POST["Register"])) {
            ...
            $Update_Query = "UPDATE Expert SET First_Name = ?, Last_Name = ?, Date_Of_Birth = ?, Age = ?, Gender = ?, Phone_Number = ?, Profile_Pic = ?, City = ?, Country = ?, Qualification = ?, Expert_In = ?, Professional_Certification = ?, Designation = ?, Organization_Name = ?, Years_of_Experience = ?, Resume = ?
                                WHERE Expert_ID = ? AND E_Mail = ?
                            ";
            ...
            if ($Streams_Done) {
                ...
                if ($Tags_Done) {
                    $Expert_Name = $Cleared['First_Name'] . " " . $Cleared['Last_Name'];
                    $Streams_Text = implode(', ', $Streams);
                    Sent_Mail($Expert_Name, $E_Mail_ID, $Expert_ID, $Streams_Text);
                    echo "
                        <script>
