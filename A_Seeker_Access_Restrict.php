...
if ($Connection) {
    ...
    function Sent_Mail($Seeker_Name, $E_Mail, $Seeker_ID)
    {
        ...
        $message = '
            ...
            <body>
                <div class="container">
                    <div class="header">Account Access Temporarily Restricted</div>
                    ...
                    <p>
                        We wanted to keep things transparent and aligned. After a routine administrative review, 
                        your learner profile on <strong>Expert Cluster</strong> has been placed under a 
                        <strong>temporary access restriction</strong>.
                    </p>
                    ...
                    <p class="note">
                        During this period, you won’t be able to explore expert streams, raise queries, or interact 
                        with platform features. This isn’t a full stop—it’s a pause for validation and quality alignment.
                    </p>

                    <p class="note">
                        Once the admin team completes the review and grants approval, your access will be restored automatically.  
                        No re-registration needed. No action required from your side right now.
                    </p>

                    <p class="note">
                        Stay patient. Stay ready. The ecosystem opens back up the moment approval is greenlit.
                    </p>
    ...
    if (isset($_POST['Deny'])) {
        ...
        if ($Update_Query_SQL->execute()) {
            Sent_Mail($Seeker_Name, $E_Mail, $Seeker_ID);
            echo "
                <script>
                    alert ('Seeker access has been denied✨');
...
<main class="content">
    <div class="Wrapper">
        <div class="Nav-Bar container-fluid d-flex flex-wrap justify-content-center align-items-center gap-3 mb-4 p-3">
            ...
            <button onclick="window.location.href = 'A_Seeker_Access_Restrict.php'" class="btn active">Restrict</button>
            <button onclick="window.location.href = 'A_Seeker_Access_Reactivate.php'" class="btn">Reactivate</button>
        </div>
        <div class="Header">
