...
if ($Connection) {
    ...
    if (isset($_POST['Page'])) {
        $_SESSION['SSR_Current_Page'] = $_POST['Page'];
    } elseif (!isset($_SESSION['SSR_Current_Page'])) {
        $_SESSION['SSR_Current_Page'] = 1;
    }

    $Page = $_SESSION['SSR_Current_Page'];
    $Page = max(1, (int)$Page);
    $Start = ($Page - 1) * $Limit;
...
<main class="content p-2">
    <div class="Wrapper">
        <div class="Nav-Bar container-fluid d-flex flex-wrap justify-content-center align-items-center gap-3 mb-4 p-3">
            ...
            <button onclick="window.location.href = 'S_Streams_Records.php'" class="btn active">Streams</button>
            <button onclick="window.location.href = 'S_Experts_Records.php'" class="btn">Experts</button>
        </div>
        <div class="Header">
    ...
    <script>
        function Form_Reset() {
            window.location.href = 'S_Streams_Records.php';
        }
    </script>
