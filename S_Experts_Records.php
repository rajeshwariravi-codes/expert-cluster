...
if ($Connection) {
    ...
    if (isset($_POST['Page'])) {
        $_SESSION['SER_Current_Page'] = $_POST['Page'];
    } elseif (!isset($_SESSION['SER_Current_Page'])) {
        $_SESSION['SER_Current_Page'] = 1;
    }

    $Page = $_SESSION['SER_Current_Page'];
    $Page = max(1, (int)$Page);
    $Start = ($Page - 1) * $Limit;
...
<main class="content">
    <div class="Wrapper">
        <div class="Nav-Bar container-fluid d-flex flex-wrap justify-content-center align-items-center gap-3 mb-4 p-3">
            <button onclick="window.location.href = 'S_Core_Records.php'" class="btn">Back</button>
            <button onclick="window.location.href = 'S_Streams_Records.php'" class="btn">Streams</button>
            <button onclick="window.location.href = 'S_Experts_Records.php'" class="btn active">Experts</button>
        </div>
        <div class="Header">
...
<script>
    function Form_Reset() {
        window.location.href = 'S_Experts_Records.php';
    }
</script>
