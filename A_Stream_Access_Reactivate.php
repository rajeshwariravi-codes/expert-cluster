...
if ($Connection) {
    ...
    function Sent_Expert_Mail($Expert_Name, $Expert_Mail, $Stream_ID, $Stream_Category, $Stream_Type, $Stream)
    {
        ...
        $mailsubject = "Administrative Update: Stream Access Activated";
        ...
        $message = '
            ...
            <body>
                <div class="container">
                    <div class="header">Stream Access Activated</div>
                    ...
                    <p>
                        We are pleased to inform you that, following a successful administrative review,
                        your previously <strong>Denied</strong> stream has now been <strong>approved and activated</strong>
                    ...
                    <p class="note">
                        This stream is now visible to learners, and you may start receiving and responding
                        to queries immediately.
                    </p>

                    <p class="note">
                        Thank you for your patience and your continued commitment to delivering high-quality,
                        accurate knowledge within the Expert Cluster ecosystem.
                    </p>
        ...
        $message = '
            ...
            <body>
                <div class="container">
                    ...
                    <p>
                        Good news 🎉 The stream that was previously marked as <strong>Denied</strong> has now been
                        <strong>reviewed and approved</strong> by our admin team and is officially <strong>active</strong> on the
                        <strong>Expert Cluster</strong> platform.
                    </p>
                    ...
                    <p class="note">
                        You can now freely explore this stream and raise queries without any restrictions.
                    </p>

                    <p class="note">
                        We appreciate your patience during the review process and encourage you to continue learning,
                        questioning, and growing with Expert Cluster.
                    </p>
        ...
        if ($Update_Query_SQL->execute()) {
            ...
            echo "
                <script>
                    ...
                    window.location.href = 'A_Stream_Access_Reactivate.php';
                </script>
                ";
        }
    }
...
<main class="content p-2">
    <div class="Wrapper">
        <div class="Nav-Bar container-fluid d-flex flex-wrap justify-content-center align-items-center gap-3 mb-4 p-3">
            ...
            <button onclick="window.location.href = 'A_Stream_Access_Restrict.php'" class="btn">Restrict</button>
            <button onclick="window.location.href = 'A_Stream_Access_Reactivate.php'" class="btn active">Reactivate</button>
        </div>
        <div class="Header">
