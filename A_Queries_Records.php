    ...
    <div class="Wrapper">
        ...
        <div id="active-content" class="content-section fade-in">
            ...
            if ($Connection) {
                ...
                $T1_Where = " WHERE Q.Query_ID LIKE ? ";
                $T1_Params[] = "%" . "SQU" . "%";
                $T1_D_Type = "s";
                                ...
                                <select class="form-select" name="T1_Stream" id="T1_Stream">
                                    ...
                                    if ($Connection) {
                                        $Select_Stream_Query = "SELECT DISTINCT 
                                                                ...
                                                                WHERE Q.Query_ID LIKE ?
                                                            ";
                                        $Select_Stream_Query_SQL = $Connection->prepare($Select_Stream_Query);
                                        $Select_Stream_Query_SQL->bind_param("s", $SQU_ID);
                                        $SQU_ID = "%SQU%";
                        ...
                        <tbody>
                            ...
                            if ($T1_Result->num_rows > 0) {
                                ...
                                while ($T1_Row = $T1_Result->fetch_assoc()) {
                                    ...
                                    echo "<td scope='row' class='text-center'> {$T1_Query_Title} </td>";
                                    echo "<td scope='row' class='text-center'>
                                            <button type='button' class='btn view-btn view-more-stream-btn mb-1'
                                                ...
                                                data-Seeker_ID='{$T1_Row['Seeker_ID']}'
                        ...
                        <?php if ($T1_Page > 1): ?>
                            <li class="page-item">
                                <form method="post" class="pagination-form">
                                    ...
                                    <input type="hidden" name="T1_Stream_Category" value="<?php echo $T1_Stream_Category; ?>">
                                    <input type="hidden" name="T1_Stream_Type" value="<?php echo $T1_Stream_Type; ?>">
                                    <input type="hidden" name="T1_Stream" value="<?php echo $T1_Stream; ?>">
                                    <input type="hidden" name="T1_Stream_Description" value="<?php echo $T1_Stream_Description; ?>">
        ...
        <div id="inactive-content" class="content-section" style="display:none;">
            ...
            if ($Connection) {
                ...
                $T2_Where = " WHERE Q.Query_ID LIKE ? ";
                $T2_Params[] = "%" . "EQU" . "%";
                $T2_D_Type = "s";
                ...
                if ($T2_Search || isset($_POST['T2_Search'])) {
                    ...
                    if (!empty($T2_Query_Status)) {
                        $T2_Where .= " AND Q.Query_Status = ? ";
                        $T2_Params[] = "%" . htmlspecialchars($T2_Query_Status, ENT_QUOTES);
                        $T2_D_Type .= "s";
                    }
                        ...
                        <tbody>
                            ...
                            if ($T2_Result->num_rows > 0) {
                                ...
                                while ($T2_Row = $T2_Result->fetch_assoc()) {
                                    ...
                                    echo "<td scope='row' class='text-center'> {$T2_Query_Title} </td>";
                                    echo "<td scope='row' class='text-center'>
                                        <button type='button' class='btn view-btn view-more-stream-btn mb-1' data-bs-toggle='modal' data-bs-target='#viewMoreStreamModal'
                                            ...
                                            data-Seeker_ID='{$T2_Row['Seeker_ID']}'
...
<script>
    function Form_Reset() {
        window.location.href = 'A_Queries_Records.php';
    }
</script>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="mb-2">
                    ...
                    <h6><strong>Seeker ID:</strong> <span id="modalSeeker_ID"></span></h6>
...
<script>
    document.querySelectorAll('.view-more-stream-btn').forEach(button => {
        button.addEventListener('click', function() {
            ...
            document.getElementById('modalSeeker_ID').textContent = this.getAttribute('data-Seeker_ID');
