...
<main class="content p-2">
    <div class="Wrapper">
        <div class="Nav-Bar container-fluid d-flex flex-wrap justify-content-center align-items-center gap-3 mb-4 p-3">
            ...
            <button onclick="window.location.href = 'A_Streams_Records.php'" class="btn active">Streams</button>
        </div>
        <div class="Header">
            ...
            ?>
                    <div class="col-md-4 mb-4 d-flex justify-content-center align-items-center">
                        <div class="card w-auto h-auto shadow-sm rounded-4 overflow-hidden">
                            ...
                            <img class="img-fluid" style="max-width: auto; min-height: 600px; max-height: 600px; object-fit:cover;" src="./Expert_Cluster_Official_Images/Streams/<?= htmlspecialchars($Row['Stream_Image']) ?>" alt="<?= $Row['Stream_Image'] ?>" loading="lazy">
                            ...
                            <div class="card-body d-flex flex-column">
                                ...
                                <p class="card-text text-muted"><?= $Row['Stream_Description'] ?></p>
                            </div>
                        </div>
                    </div>
            <?php
